...
def update():
    ...
    task = executor.submit(run_task, task_id, site, received_text, title)
...
def run_task(task_id, site, received_text, title):
  print("RUN TASK: ", site, received_text[:10])
  sm.update(site, received_text, title)
  return
...
def search():
    ...
    results = {'top_sites': [u for u,t,c in results], 'top_titles': [t for u,t,c in results], 'top_context': [c for u,t,c in results]}
